...
class Utils {
    constructor(target, ...args) {
        ...
        for (let k in decode) {
            this.decode[k] = function () {
                let input = arguments.length ? [this.curr_target, ...arguments] : [this.curr_target, ...args];
    ...
    [util.inspect.custom](depth, options) {
        return this.curr_target;
    }
    val() {
        return this.curr_target;
    }
    slice() {
        this.curr_target = this.curr_target.slice(...arguments);
        return this;
    }
    replace() {
        this.curr_target = this.curr_target.replace(...arguments);
        return this;
    }
}
